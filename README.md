...
```bash
curl -sSL https://raw.githubusercontent.com/ithinkido/penplotter-webserver/Bullseye_32_Pi_OS/install.sh | bash
```
...
After install, open a browser and open a browser window at:
```bash
